...
\begin{figure}[h]
  ...
  \subfloat[Navier-Stokes with ML model, $n_\mathrm{iter}=10$, $\Delta t=10^{-6}$\,s]{\includegraphics[width=0.475\textwidth]{Figures/errorCvg_diff_adv_pressure_NN_iter10_dt1e-06.pdf}}
    \subfloat[Navier-Stokes with ML model, $n_\mathrm{iter}=10$, $\Delta t=10^{-5}$\,s]{\includegraphics[width=0.475\textwidth]{Figures/errorCvg_diff_adv_pressure_NN_iter10_dt1e-05.pdf}}
